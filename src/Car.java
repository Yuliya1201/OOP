public class Car {
    ...
    Car (String brend, String model, String EngineVolume, String Color, int year, String country) {
        this.brend = brend;
        if (brend == "" || brend ==null) {
            brend = "default";
        }
...
//16 год.Hyundai Avante, сборка в Южной Корее, цвет кузова — оранжевый, объем двигателя — 1,6 л, год выпуска — 20
//Напишите программу, которая будет выводить в консоль информацию о каждом автомобиле и все указанные выше характеристики.
    ...
    //Задание 2 Домашнее часть 2
//Перепишите класс «Автомобиль» с использованием конструктора. Передайте все свойства созданных вами
// объектов машин с помощью конструктора.
